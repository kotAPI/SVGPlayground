var CONFIGSVG = {width:1200,height:500,gameSpeed:0.7}
  ...
  g.append("circle")
   ...
   .style("fill","black")
      ...
      .duration(CONFIGSVG.gameSpeed*1000)
        ...
        g.append("text").attr("id","text"+id).attr("x",x).attr("y",y).text(textcontent+"")
            .attr("text-anchor","middle").attr("dominant-baseline", "central")
})

var highlightNode = (id) => new Promise((resolve,reject)=>{
    ...
    var targetElement = d3.select("#"+"group"+id)
        ...
        targetElement
          ...
          .transition()
              ...
              .style("fill","green").attr("stroke-width","0").attr("stroke","#000000b5")
              .duration(CONFIGSVG.gameSpeed*400).on("end",resolve)
})
...
var moveNode = (id,x,y,delay,duration) => new Promise((resolve,reject)=>{
    ...
    var text = d3.select("#"+"text"+id).transition().delay(delay).attr("x",x).attr("y",y).duration(CONFIGSVG.gameSpeed*1000)
})

var drawEdge = (fromid,toid,x1,y1,x2,y2,duration,delay) => new Promise((resolve,reject)=>{
...
var resetNodes = () => new Promise(()=>{
    d3.selectAll("circle")
        .style("fill","red")
})
var resetEdges = () => new Promise((resolve,reject)=>{
    d3.selectAll("line")
        .attr("stroke-width",2)
        .style("stroke","black")
})
var highlightEdge = (fromid,toid) => new Promise((resolve,reject)=>{

    var edge = d3.select("g")
...
var selectEdge = (fromid,toid) => new Promise((resolve,reject)=>{
